...
RSpec.describe 'the veterinarian update' do
  it "shows the veterinarian edit form" do
    shelter = Shelter.create(name: 'Hollywood shelter', city: 'Irvine, CA', foster_program: false, rank: 7, address: '583 Fake Ave, Harlingen, TX, 58375')
  ...
  context "given valid data" do
    it "submits the edit form and updates the veterinarian" do
      shelter = Shelter.create(name: 'Heavenly pets', city: 'Aurora, CO', foster_program: true, rank: 7, address: '583 Fake Ave, Harlingen, TX, 58375')
  ...
  context "given invalid data" do
    it 're-renders the edit form' do
      shelter = Shelter.create(name: 'Heavenly pets', city: 'Aurora, CO', foster_program: false, rank: 7, address: '583 Fake Ave, Harlingen, TX, 58375')
